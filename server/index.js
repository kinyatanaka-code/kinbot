...
const BUILD_TAG = "2026-09-02aj 今日の商談の「予定」段階でも担当を割り当て可能に：その日のアポ(/api/apo/pickup)と予定を予定IDで突き合わせ、対応するアポ(smart-link)の担当をPUT。選んだ担当のアポ/予定に反映される。前回：リマインドのモーダル最前面化＋今日の商談の担当変更";
