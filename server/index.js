...
const BUILD_TAG = "2026-09-04dg 獲得見込みインセンティブ：同じ金額なら同順位（1位タイ）に、月桂冠の装飾を追加（要望：田中さん）。順位付けを金額のユニーク降順上位3段階に対して付与＝同額は同順位、同額が複数なら『◯位タイ』表記。金額を月桂冠で左右から挟む表示。前回(df)：獲得見込み表記。";
