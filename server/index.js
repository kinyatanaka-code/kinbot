...
const BUILD_TAG = "2026-09-04eh 携帯からも商談名を変えられるように（要望：田中さん）。狭い画面では商談履歴の見出しを縦に並べ、商談名の入力欄を横幅いっぱい・文字サイズ16pxで表示（iOSの自動ズーム防止）。操作ボタンも折り返さず読める形に。前回(eg)：取り込みボタンを商談履歴へ移動。";
