...
const BUILD_TAG = "2026-09-04df インサイドカードのインセンティブ表記を『獲得見込みインセンティブ』に変更（要望：田中さん）。ラベルが長くなるため文字サイズを微調整。金額計算(9月からの3か月の実施数×¥1,000)・上位3人の金銀銅は変更なし。前回(de)：インセンティブ表示を追加。";
