...
- 2026-08-29 Chatの「開発メモ」表示を、一語だけでなく文でも受けられるようにした（メモID 749「開発メモを見せて」・750「開発メモの内容をここで送って」が“できないこと”として溜まっていた）。parseCommand で「開発メモ／要件メモ／要望メモ」を含む文はすべて notes（一覧表示）にする。「要望 〜」等の“残す”指示は先に処理済みなので、ここに来るのは“見たい”意図。
